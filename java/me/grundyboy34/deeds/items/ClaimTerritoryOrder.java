...
public class ClaimTerritoryOrder extends _ItemBase
{
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean par4)
	{
		...
		if (factionName == null)
		{
			// Blank
			list.add(" ");
			list.add(TextFormatting.YELLOW + "A LEADER has to sign this first by USING it.");
			list.add(TextFormatting.YELLOW + "They can sign a whole stack at once.");
		}
		else
		{
			...
			list.add(" ");
			list.add(TextFormatting.YELLOW + "Only chunks adjacent to this claim's");
			list.add(TextFormatting.YELLOW + "territory can be claimed.");
			list.add(" ");
			list.add(TextFormatting.RED + "Used up on successful claim.");
		}
		...
		{
			list.add(" ");
			list.add(TextFormatting.BLUE + "This chunk is claimed by " + faction.getName() + ".");
		}
    }
