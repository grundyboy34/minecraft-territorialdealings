...
import me.grundyboy34.deeds.items.ClaimTerritoryOrder;
import me.grundyboy34.deeds.items.FactionRenameOrder;
import me.grundyboy34.deeds.items.StartFactionDeed;
...
public class Main 
{
	...
	public static final String modID = "deeds";	// For ease of access
	...
	public void init(FMLInitializationEvent event) {
		NetworkRegistry.INSTANCE.registerGuiHandler(this.instance, new DeedsGuiHandler());
	}
